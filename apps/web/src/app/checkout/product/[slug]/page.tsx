  ...
  async function submit() {
    ...
    try {
      ...
      const razorpay = new (window as any).Razorpay({
        ...
        amount: paymentOrder.amountInr * 100,
        currency: 'INR',
        name: 'poozari.com',
        ...
        handler: async (response: unknown) => {
          try {
            ...
            setError(e.message ?? 'Payment could not be verified');
            setSubmitting(false);
          }
        },
        modal: {
          ...
          <div className="elevated-card sticky top-20 bg-white p-6">
            ...
            <div className="mt-5 flex gap-4">
              ...
              <div>
                ...
                <div className="mt-1 text-xs font-bold text-accent">{formatInr(product.priceInr)} each</div>
              </div>
            </div>
            <div className="mt-6 space-y-3 border-t pt-5 text-xs">
              ...
              <div className="flex items-center justify-between border-t pt-4">
                ...
                <span className="font-display text-xl font-black text-accent">{formatInr(total)}</span>
              </div>
            </div>
            <button
              type="button"
