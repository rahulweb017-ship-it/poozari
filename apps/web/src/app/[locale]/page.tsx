...
const STEPS = [
  {
    ...
    desc: 'Specify the puja, date, family details, and personal gotra.',
    icon: '📝',
  },
  {
    title: 'Pujari Auto-Match',
    desc: 'Our system instantly assigns a verified pandit matching your location.',
    icon: '🛡️',
  },
  {
    title: 'Premium Samagri',
    desc: 'We arrange all organic, high-quality ritual items beforehand.',
    icon: '📦',
  },
  {
    title: 'Authentic Rituals',
    desc: 'Vedic chants and ceremonies performed according to shastras.',
    icon: '🪔',
  },
  {
    title: 'Video Proof & Prasad',
    desc: 'Receive a recording of the puja and holy prasad at your home.',
    icon: '🎥',
  },
];
...
const FEATURES = [
  {
    ...
    desc: 'All ceremonies strictly follow Vedic scriptures, managed by authorized, vetted pandits.',
    icon: (
  ...
  {
    title: 'Verified Pujari Directory',
    desc: 'Priests are screen-vetted for scriptural knowledge, experience, and area specialization.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Consult our booking desk for guidance on muhurat selection and custom arrangements.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const TRUST = [
  { icon: '🛡️', label: 'Vetted Pandits' },
  { icon: '📦', label: 'Complete Samagri' },
  { icon: '📜', label: 'Scriptural Rigor' },
  { icon: '🎧', label: 'Muhurat Support' },
];
  ...
  return (
    <div>
        ...
        <div className="app-container">
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="text-center lg:text-left">
              <span className="section-pill">Ancient Faith, Modern Trust</span>
              <h1 className="display-title mt-4">
                Book <span className="text-accent">Authentic Vedic Puja</span> with Vetted Priests
              </h1>
              <p className="mx-auto mt-5 max-w-xl px-1 text-sm leading-relaxed sm:text-base lg:mx-0 lg:px-0"
                 style={{ color: 'hsl(var(--muted-foreground))' }}>
                Coordinate Vedic ceremonies seamlessly. We source authentic samagri, assign verified localized pandits, and deliver recorded proof directly to your home.
              </p>

              {/* Trust badges */}
              <ul className="mt-8 grid grid-cols-2 gap-3 sm:gap-4 md:mx-auto md:max-w-md lg:mx-0 lg:max-w-none lg:grid-cols-4">
                {TRUST.map((t) => (
                  <li key={t.label} className="flex min-h-[48px] items-center gap-3 text-left">
              ...
              <p className="mt-6 text-2xs font-extrabold uppercase tracking-widest" style={{ color: 'hsl(var(--muted-foreground))' }}>
                ...
                Guided booking assistance on call &amp; WhatsApp
              </p>
            </div>
          ...
          <div className="mx-auto mt-12 max-w-7xl border-t pt-6" style={{ borderColor: 'hsl(var(--border) / 0.5)' }}>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-6">
              {[
                ...
                ['500+', 'Verified Priests'],
                ['100+', 'Temples Connected'],
                ['15+', 'Cities Served'],
              ].map(([val, label]) => (
        ...
        <div className="app-container">
          <div className="flex flex-col items-center text-center mx-auto max-w-4xl">
            ...
            <h2 className="section-heading mt-3">
              What Is <span className="text-accent">poozari?</span>
            </h2>
            <div className="section-bar mx-auto" aria-hidden="true" />
            <p className="section-subheading mx-auto">
              Poozari is a dedicated Vastu and Vedic service coordination desk. We handle localized priest matching, source organic samagri lists, schedule muhurats, and arrange high-definition recorded proofs. You focus on devotion — we take care of details.
            </p>
          </div>
        ...
        <section className="section--compact relative overflow-hidden" style={{ background: 'hsl(var(--card))' }}>
          <div className="app-container relative z-10">
            <div className="flex flex-col items-center text-center mb-12">
              <span className="section-pill">Sacred Gallery</span>
              <h2 className="section-heading mt-3">
                Holy <span className="text-accent">Teerth Cities</span>
              </h2>
              <div className="section-bar mx-auto" aria-hidden="true" />
              <p className="section-subheading mx-auto">
                Explore major teerths and coordinate temple pujas.
              </p>
            </div>
              ...
              {cities.map((c) => (
                ...
                >
                  ...
                  <p className="mt-1 text-3xs font-extrabold uppercase tracking-widest text-muted-foreground">
                    {c.templeCount ?? 0} Temples Served
                  </p>
                </Link>
              ))}
            </div>
            <div className="mt-12 text-center">
              <Link href="/teerth-puja" className="btn-outline btn-lg rounded-full">
                Explore All Teerth Cities <span aria-hidden="true">→</span>
              </Link>
            </div>
          </div>
        </section>
      ...
      <section className="section--compact">
        <div className="app-container">
          <div className="flex flex-col items-center text-center mb-12">
            <span className="section-pill">At Home</span>
            <h2 className="section-heading mt-3">
              Home <span className="text-accent">Services</span>
            </h2>
            <div className="section-bar mx-auto" aria-hidden="true" />
            <p className="section-subheading mx-auto">
              We match localized priests to your doorstep, bringing all organic samagri elements.
            </p>
          </div>
          {homePujas.length ? (
          ...
          {homePujas.length > 4 && (
            <div className="mt-10 text-center">
              <Link href="/puja" className="btn-outline rounded-full">
                View all home pujas <span aria-hidden="true">→</span>
              </Link>
            </div>
          )}
        </div>
      ...
      <section className="section--compact" style={{ background: 'hsl(var(--card))' }}>
        <div className="app-container">
          <div className="flex flex-col items-center text-center mb-12">
            <span className="section-pill">Sacred Rites</span>
            <h2 className="section-heading mt-3">
              Sacred <span className="text-accent">Teerth Pujas</span>
            </h2>
            <div className="section-bar mx-auto" aria-hidden="true" />
            <p className="section-subheading mx-auto">
              Authorized pandits coordinate remote rituals on your behalf.
            </p>
          </div>
          {teerthPujas.length ? (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="section--compact bg-accent-soft border-t" style={{ borderColor: 'hsl(var(--border) / 0.3)' }}>
        <div className="app-container">
          <div className="flex flex-col items-center text-center mb-12">
            <span className="section-pill">Ritual Steps</span>
            <h2 className="section-heading mt-3">
              Standard <span className="text-accent">Booking Flow</span>
            </h2>
            <div className="section-bar mx-auto" aria-hidden="true" />
          </div>
  ...
  return (
    <div className="card p-12 text-center">
      ...
      <p className="mt-3 text-xs font-bold uppercase tracking-wider text-muted-foreground">
        No pujas available yet. Run the API seed to load sample pujas.
      </p>
